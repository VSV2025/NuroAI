...
def run_pipeline(text: str, ocr_result: dict, author_baseline: dict | None = None) -> dict:
    ...
    return {
        ...
        "crossLanguage":    {
            ...
            "embedding_similarity":       cross.get("embedding_similarity", 0.0),
            "translation_similarity":     cross.get("translation_similarity", 0.0),
            "structure_similarity":       cross.get("structure_similarity", 0.0),
            "keyword_preservation":       cross.get("keyword_preservation", 0.0),
            "final_cross_language_score": cross.get("final_cross_language_score", 0),
        },
